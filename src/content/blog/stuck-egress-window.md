---
title: "Egress Window Won't Open? Here's What's Going On"
navTitle: "Egress Window Won't Open?"
metaTitle: "Egress Window Won't Open? Causes & Fixes in Lincoln"
metaDescription: "An egress window won't open for a handful of common reasons, from swollen frames to a flooded well. Here's how to diagnose it and what repairs cost in Lincoln."
primaryKeyword: "egress window won't open"
secondaryKeywords: "stuck egress window, egress window stuck, basement window won't open, egress window repair Lincoln NE, window well flooding frame"
publishedDate: "2026-07-07"
tag: "Well Care"
subtitle: "You push on the crank, lean into the frame, and your basement bedroom's window still won't budge. If an egress window won't open, that's not a small annoyance."
canonical: "https://lincolnegresswindows.com/blog/stuck-egress-window/"
faq:
  - question: "Is it dangerous if my egress window won't open?"
    answer: "Yes, in the sense that matters most: it removes the emergency exit that room is legally required to have. It's not an immediate hazard sitting there, but it becomes one the moment there's a fire or the primary stairway is blocked. Treat it as a priority repair, not a someday project."
  - question: "Can I fix a stuck egress window myself?"
    answer: "Sometimes. Paint seals, dirty tracks, and minor hardware sticking are reasonable DIY fixes with basic tools. Warped frames, cracked or fogged glass, and rusted-through hardware are not, since forcing those can turn a repairable window into a full replacement."
  - question: "How much does it cost to fix an egress window that won't open?"
    answer: "It ranges from free to a few thousand dollars depending on the cause. Cleaning and lubricating hardware can run under $200, while a warped frame from water damage typically costs $1,200-$3,000 to replace in the existing opening."
  - question: "Will a stuck egress window fail a home inspection?"
    answer: "Almost certainly. Inspectors physically test every egress window, and one that won't open is a standard item on inspection reports. It's far better to fix it before listing your home than to have it flagged and rushed during a sale."
---
You push on the crank, lean into the frame, and your basement bedroom's window still won't budge. If an egress window won't open, that's not a small annoyance. That window is the one thing standing between someone sleeping down there and a way out in a fire, and it's the first thing a home inspector or building official checks.
...
If your window well fills with water, leaves, or silt on a regular basis, that's worth addressing before it becomes a window problem. We walk through the fixes in our post on [clearing a clogged window well drain](/blog/window-well-drain-clogged/), and our piece on [Nebraska's freeze-thaw cycle and window well damage](/blog/nebraska-freeze-thaw-window-well-damage/) explains why this region is particularly hard on frames.
...
If you've gone through the basics and the window still won't move, or if you're seeing any of those warning signs, don't keep pushing on it. Call us at [(844) 817-0274](tel:+18448170274) and we'll get someone out to look at it, usually within a day or two.
...
|---|---|---|
| Painted or dirty seal | Paint bond, debris in track | $0-$165 (DIY or minor service call) |
| Worn or rusted hardware | Stripped crank gear, rusted hinge, worn rollers | $150-$600 |
| Warped frame from window well water damage | Poor drainage, standing water against frame | $1,200-$3,000 (replacement in existing opening) |
| No functioning egress window at all | Never cut in, or damage too extensive to repair | $3,500-$7,000 (new cut-in installation) |
...
Keep in mind that Lincoln requires a permit for egress window replacement and cut-in work, which typically runs $75 to $200 on top of the project itself. We pull that permit as part of the job, so it's already factored into the estimates we give you, not an extra line item that shows up later. Whatever category your window falls into, we'll give you a free written estimate before anything starts. [Contact us online](/#contact) or call [(844) 817-0274](tel:+18448170274) to get a technician out.
...
Home inspectors test every basement egress window by hand, and a window that doesn't open is one of the most common red flags they write up. That single item can hold up financing, spook a buyer, or force a rushed repair during closing, like it did for Todd and Carla. [Lincoln's Building & Safety department](https://www.lincoln.ne.gov/City/Departments/PDS/Building-Safety/Residential-Charts-and-Diagrams/Typical-Egress-Window-and-Well-Detail) publishes the official egress window and well diagram used for permits, which is worth reviewing if you want to see the exact size and clearance requirements for your property.

We've written more on what inspectors specifically look for in our post on [home inspection egress window red flags](/blog/home-inspection-egress-window-red-flags/), which is worth a read if you're planning to sell in the next year or two.
